...
urlpatterns = [ # Url appartenenti all'app gbliometrics
    ...
    path('snapshots/snapshot-get/<str:groupId>/', views.snapshotGet, name='snapshot-get'), # Creazione del dizionario dello Snapshot del gruppo specificato dall'utente
